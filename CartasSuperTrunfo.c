...
int main()
{
  ...
  float areaCidade01= 1500.f, areaCidade02= 1500.f;
  ...
  */
  ...
  printf("\n\n Hora de comparar as cartas!, escolha dois valores para comparação\n");
  ...
  //escolhas do atributo a comparar, decidi usar do while para que o programa não feche quando o usuario digita valores invalidos
  do{
  printf("\nfaça a primeira escolha: "); 
  scanf("%d", &escolha01);
  printf("faça a segunda escolha: "); 
  scanf("%d", &escolha02);
  if (escolha01 == escolha02){
    printf("As escolhas não podem ser iguais, por favor escolha novamente.\n");
  }
  if (escolha01 < 1 || escolha01 > 6 || escolha02 < 1 || escolha02 > 6){
    printf("As escolhas devem estar entre 1 e 6, por favor escolha novamente.\n");
  }
  }while (escolha01 == escolha02 || escolha01 < 1 || escolha01 > 6 || escolha02 < 1 || escolha02 > 6);
 
  //fiz dois switchs, para analizar os resultados não sei se é a ideia era usar void ou fazer dessa forma, o if else foi substituido por operador ternario
  switch (escolha01)
  {
  case 1:
   ...
   populacaoCidade01> populacaoCidade02 ? printf("A carta1 venceu! A cidade com maior população é %s\n", nomeCidade01): 
   (populacaoCidade02> populacaoCidade01 ? printf("A carta2 venceu! A cidade com maior população é %s\n", nomeCidade02):
  ...
  areaCidade01> areaCidade02 ? printf("A carta1 venceu! A cidade com maior área é %s\n", nomeCidade01): 
  (areaCidade02> areaCidade01 ? printf("A carta2 venceu! A cidade com maior área é %s\n", nomeCidade02):
  ...
  pibCidade01> pibCidade02 ? printf("A carta1 venceu! A cidade com maior PIB é %s\n", nomeCidade01): 
  (pibCidade02> pibCidade01 ? printf("A carta2 venceu! A cidade com maior PIB é %s\n", nomeCidade02):
  ...
  densidadePopulacional01< densidadePopulacional02 ? printf("A carta1 venceu! A cidade com menor densidade populacional é %s\n", nomeCidade01): 
  (densidadePopulacional02< densidadePopulacional01 ? printf("A carta2 venceu! A cidade com menor densidade populacional é %s\n", nomeCidade02):
  ...
  pibPerCapita01> pibPerCapita02 ? printf("A carta1 venceu! A cidade com maior PIB per capita é %s\n", nomeCidade01): 
  (pibPerCapita02> pibPerCapita01 ? printf("A carta2 venceu! A cidade com maior PIB per capita é %s\n", nomeCidade02):
